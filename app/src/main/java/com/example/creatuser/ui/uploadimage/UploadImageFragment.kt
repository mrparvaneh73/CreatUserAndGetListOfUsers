...
class UploadImageFragment:Fragment(R.layout.fragment_uploadimage) {
    ...
    private val viewmodel by viewModels<UploadImageFragmentViewModel>()
    val cameraluncher = registerForActivityResult(ActivityResultContracts.TakePicturePreview()) {
        imageByteArray = it.toByteArray()
        binding.profileImage.setImageBitmap(it)
    }
    val selectPictureLuncher = registerForActivityResult(ActivityResultContracts.GetContent(), {
